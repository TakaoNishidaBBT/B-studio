		...
		<ul class="upload_control">
			...
			<li>
				<div id="upload_button" class="input_container">
					<a href="index.php?terminal_id=<?php echo TERMINAL_ID ?>&module=resource&page=upload" title="アップロード" class="upload-button bframe_upload" onclick="activateModalWindow(this, 440, 500, reloadTree); return false;"><img src="images/common/save.png" alt="アップロード" />アップロード</a>
				</div>
			</li>
		</ul>
