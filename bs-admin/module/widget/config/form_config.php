...
$form_config = array(
	...
	array(
		'start_html'	=> '<div class="editor_container bframe_adjustwindow" data-param="margin:14" >',
		'end_html'		=> '</div>',
		array(
			'start_html'	=> '<div id="html" class="text_editor bframe_adjustparent" data-param="margin:15">',
			'end_html'		=> '</div>',
			array(
				'id'			=> 'html_editor',
				'name'			=> 'html',
		...
		array(
			'start_html'	=> '<div id="css" class="text_editor bframe_adjustparent" data-param="margin:15" style="display:none">',
			'end_html'		=> '</div>',
			array(
				'id'			=> 'css_editor',
				'name'			=> 'css',
		...
		array(
			'start_html'	=> '<div id="php" class="text_editor bframe_adjustparent" data-param="margin:15" style="display:none">',
			'end_html'		=> '</div>',
			array(
				'id'			=> 'php_editor',
				'name'			=> 'php',
		...
		array(
			'start_html'	=> '<div id="preview" class="bframe_adjustparent" data-param="margin:16" style="display:none">',
			'end_html'		=> '</div>',
			array(
...
$tab_control_config = array(
	...
	array(
		...
		'link'				=> 'preview',
		'value'				=> __('Preview'),
		'attr'		=> 'class="bframe_tab" onclick="bframe.preview.submit(\'F1\', \'' . B_SITE_BASE . 'index.php' . '\', \'widget_preview\', \'preview_frame\'); return false;"',
	),
	array(
