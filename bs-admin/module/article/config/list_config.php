...
$list_config = array(
	...
	'select_sql'	=> "select b.total_cnt, c.access_cnt, a.* from " . B_DB_PREFIX . "v_admin_article a
						left join (
							select article_id, count(*) total_cnt from " . B_DB_PREFIX . "access_log
							group by article_id) b
						on a.article_id = b.article_id
						left join (
							select article_id, count(*) access_cnt from " . B_DB_PREFIX . "access_log
