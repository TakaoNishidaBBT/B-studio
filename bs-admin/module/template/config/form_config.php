...
$form_config = array(
	...
	array(
		...
		'end_html'		=> '</div>',
		array(
			'start_html'	=> '<div id="html" class="bframe_adjustwindow" param="margin:8">',
			'end_html'		=> '</div>',
			array(
				'start_html'	=> '<div class="text_editor start_html" style="height:300px;">',
				'end_html'		=> '</div>',
				array(
					'name'				=> 'start_html',
					'class'				=> 'B_TextArea',
			...
			array(
				'start_html'	=> '<div class="text_editor end_html" style="height:300px; margin-top:10px">',
				'end_html'		=> '</div>',
				array(
					'name'				=> 'end_html',
					'class'				=> 'B_TextArea',
		...
		array(
			'start_html'	=> '<div id="css" class="text_editor bframe_adjustparent" param="margin:30" style="display:none">',
			'end_html'		=> '</div>',
			array(
				'id'				=> 'css_editor',
				'name'				=> 'css',
		...
		array(
			'start_html'	=> '<div id="php" class="text_editor bframe_adjustparent" param="margin:30" style="display:none">',
			'end_html'		=> '</div>',
			array(
				'id'				=> 'php_editor',
				'name'				=> 'php',
