<body onload="bframe.effect.fadeIn(document.body, 100, 0, 100, 50);" style="opacity:0">
	...
	<h2><span class="accent"></span><?php echo _('Templates'); ?><span><?php echo $this->version_info; ?></span></h2>
	<div class="header"></div>
	<iframe class="tree bframe_splitter_pane bframe_adjustwindow" param="margin:10" frameborder="0" src="<?php echo DISPATCH_URL ?>&module=template&page=tree"
	...
	<iframe class="form bframe_splitter_pane bframe_adjustwindow" param="margin:10" frameborder="0" src="<?php echo DISPATCH_URL ?>&module=template&page=form&method=init"
