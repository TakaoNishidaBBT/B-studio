<body spellcheck="false" onload="bframe.effect.fadeIn(document.body, 100, 0, 100, 50);" style="opacity:0">
	<h2><span class="accent"></span><?php echo __('File Manager'); ?></h2>
	...
	<div id="bframe_tree_container" class="bframe_tree_container bframe_splitter_pane bframe_adjustwindow" data-param="margin:10">
		<div id="tree_box" class="bframe_adjustparent" data-param="margin:1">
	...
	<div id="filemanager_pane" class="bframe_splitter_pane bframe_adjustwindow" data-param="margin:10">
		...
		<div class="pane_container">
			<div id="bframe_pane" class="bframe_pane bframe_adjustparent" data-param="margin:62"></div>
		</div>
	</div>
